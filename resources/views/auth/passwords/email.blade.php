                    ...
                    <div class="card-header">{{ __('パスワードリセット') }}</div>
                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-2">パスワードをお忘れですか?</h1>
                                                <p class="mb-4">メール アドレスを入力してください。<br>パスワードリセット用のリンクが送信されます。</p>
                                            </div>
                                            <hr>
                                ...
                                <div class="text-center">
                                    <a class="small" href="/register">アカウントをお持ちでない方</a>
                                </div>
                                <div class="text-center">
                                    <a class="small" href="{{ route('login') }}">既にアカウントをお持ちですか？</a>
                                </div>
                            </div>
                        </div>
                    </div>
